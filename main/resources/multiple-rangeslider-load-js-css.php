...
function MRSGFenqueue_custom_script() {
    ...
    wp_enqueue_style( 'MRSGF-jquery-ui-css', MRSGF_PLUGIN_DIR .'/assets/css/jquery-ui.css', false, '1.0.0' );  
    wp_enqueue_script( 'RSFFCF7-range-jquery-ui-js', MRSGF_PLUGIN_DIR .'/assets/js/range-jquery-range.min.js', false, '1.12.1' );
    wp_enqueue_style( 'MRSGF-jquery-ui-slider-pips-css', MRSGF_PLUGIN_DIR .'/assets/css/jquery-ui-slider-pips.css', false, '1.0.0' ); 
    wp_enqueue_script( 'MRSGF-jquery-ui-slider-pips-js', MRSGF_PLUGIN_DIR .'/assets/js/jquery-ui-slider-pips.js', false, '1.0.0',true );
    wp_enqueue_script( 'MRSGF-single-front-js', MRSGF_PLUGIN_DIR.'/assets/js/srsfg_front.js',array('jquery'),'',true);
    wp_enqueue_script( 'MRSGF-multiple-front-js', MRSGF_PLUGIN_DIR.'/assets/js/mrsfg_front.js',array('jquery'),'',true);
    wp_enqueue_script( 'MRSGF-label-front-js', MRSGF_PLUGIN_DIR.'/assets/js/slabel_front.js',array('jquery'),'',true);
}
