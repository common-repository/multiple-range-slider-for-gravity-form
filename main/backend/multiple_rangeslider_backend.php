...
if (class_exists('GF_Field')) {
    class MRSGF_Field_Rangeslider extends GF_Field {
        ...
        public function get_form_editor_field_title() { return esc_attr__( 'Double Edge Range slider', 'multiple-range-slider-for-gravity-form-pro' ); }
...
function MRSGF_set_default_values(){
    ?>
    case "Rangeslider" :
        field.label = 'Double Edge Range Slider';
        field.min = 1;
        field.max = 23;
        field.stepvalue = 4;
        field.Prefixvalue = '%';
